...
const roles = ref([])
  ...
  const submitDate=()=>{
    ...
    formData.append("password_confirmation",userDate.confirmPassword);
   ...
   <form @submit.prevent="submitDate">
     <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
       ...
       <div>
         ...
         <div class="relative">
           <input v-model="userDate.email" type="email" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Enter your email" />
           <span class="absolute right-3 top-2.5 text-gray-400">
       ...
       <div>
         ...
         <div class="relative">
           <input v-model="userDate.confirmPassword" type="password" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Confirm password" />
           <span class="absolute right-3 top-2.5 text-gray-400">
             <i class="fas fa-eye-slash"></i>
           </span>
         </div>
