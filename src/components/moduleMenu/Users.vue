	...
	<li>
		...
		>
			...
			<ChevronRight
				:color="'currentColor'"
				:class="{
					'rotate-90 transition-transform': props.activeMenu === 'users',
					'transition-transform': props.activeMenu !== 'users',
				}"
				class="w-4 h-4"
			/>
		</button>
